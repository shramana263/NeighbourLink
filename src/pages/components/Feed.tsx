...
const Feed: React.FC = () => {
    ...
    return (
        <div className="container w-full sm:w-[700px] mt-16 mx-auto px-4 py-8 bg-transparent">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border-l-4 border-blue-500">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <div className="flex gap-2 items-center mt-3 text-[10px] text-gray-500 dark:text-gray-400">
                ...
                {resource.images && resource.images.length > 0 && (
                    <div className="ml-4 flex-shrink-0">
                        <div className="w-20 h-20 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden">
                            <p className="text-xs text-gray-500 dark:text-gray-400 p-1">Image: {resource.images[0]}</p>
                        </div>
                    </div>
                )}
            </div>
...
export const PromotionCard: React.FC<PromotionCardProps> = ({ promotion }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border-l-4 border-purple-500 dark:border-purple-400">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <h3 className="text-md font-semibold text-gray-900 dark:text-white">{promotion.responders?.title || 'Promotion'}</h3>
                    <p className="text-xs text-gray-600 dark:text-gray-300 mt-1">{promotion.description}</p>

                    <div className="text-[10px] flex flex-col mt-3 text-sm ">
                        <p className="text-gray-700 dark:text-gray-300">Contact: {promotion.contactInfo?.name}</p>
                        <p className="text-gray-700 dark:text-gray-300">Email: {promotion.contactInfo?.email}</p>
                        <p className="text-gray-700 dark:text-gray-300">Phone: {promotion.contactInfo?.contact}</p>
                ...
                {promotion.images && promotion.images.length > 0 && (
                    <div className="ml-4 flex-shrink-0">
                        <div className="w-20 h-20 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden">
                            <p className="text-xs text-gray-500 dark:text-gray-400 p-1">Image: {promotion.images[0]}</p>
                        </div>
                    </div>
                )}
            </div>
...
const EventCard: React.FC<EventCardProps> = ({ event }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border-l-4 border-green-500 dark:border-green-400">
            <div className="flex justify-between items-start">
                <div>
                ...
                {event.images && event.images.length > 0 && (
                    <div className="ml-4 flex-shrink-0">
                        <div className="w-20 h-20 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden">
                            <p className="text-xs text-gray-500 dark:text-gray-400 p-1">Image: {event.images[0]}</p>
                        </div>
                    </div>
                )}
            </div>
...
const UpdateCard: React.FC<UpdateCardProps> = ({ update }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border-l-4 border-amber-500 dark:border-amber-400">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <div className="flex flex-col items-start mt-3 text-[10px] text-gray-500 dark:text-gray-400">
                        {updateDate && (
                           
                            <span>Update Date: {updateDate}</span>

                        )}
                        <span className=''>Posted: {createdDate}</span>
                    </div>
                </div>
                ...
                {update.images && update.images.length > 0 && (
                    <div className="ml-4 flex-shrink-0">
                        <div className="w-20 h-20 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden">
                            <p className="text-xs text-gray-500 dark:text-gray-400 p-1">Image: {update.images[0]}</p>
                        </div>
                    </div>
                )}
            </div>
