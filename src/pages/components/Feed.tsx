  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 rounded-lg shadow-md border-l-4 ${
        resource.urgency == "high" ? "border-red-500 " : "border-blue-500 "
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-xs font-light text-gray-600 dark:text-gray-300 mt-1">
          ...
          <div className="relative cursor-pointer" ref={menuRef}>
            ...
            {showMenu && (
              <div className="absolute right-0 mt-1 w-32 bg-white dark:bg-gray-700 overflow-hidden rounded-md shadow-lg py-1 z-20">
                ...
                <button
                  className="block w-full px-4 py-2 text-sm text-left text-blue-600 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer"
      ...
      <div className="p-4">
        ...
        <div className="mt-3 text-[10px]">
          <div className="flex items-center text-gray-700 dark:text-gray-300">
            ...
            <span>
              Date: {event.timingInfo?.date} - Time: {event.timingInfo?.time}
            </span>
          </div>
          ...
          <div className="mt-3">
            ...
            {event.responders?.users && (
              <p className="text-xs text-gray-500 mt-1">
                ...
                {event.responders.users.length === 1 ? "person" : "people"}{" "}
                attending
              </p>
            )}
          </div>
