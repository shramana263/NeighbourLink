...
import { Home, User, FileText, Share, Inbox, Archive, HeartHandshake } from "lucide-react";
...
const Sidebar = ({  handleLogout, isSidebarOpen }: SidebarProps) => {
  ...
  const navItems = [
    ...
    { path: "/profile/shared-skills", label: "Skill Sharing", icon: <HeartHandshake size={18} /> },
  ];
